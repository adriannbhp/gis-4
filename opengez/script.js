document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://raw.githubusercontent.com/adriannbhp/open-layers/main/opengez/geoJSONPoint.json") // Ganti "data.json" dengan nama file JSON Anda
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://raw.githubusercontent.com/adriannbhp/open-layers/main/opengez/geoJSONPolygon.json") // Ganti "data.json" dengan nama file JSON Anda
        .then(response => response.json())
        .then(data => {
            data.features.forEach(feature => {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://raw.githubusercontent.com/adriannbhp/open-layers/main/opengez/geoJSONLineString.json") // Ganti "data.json" dengan nama file JSON Anda
        .then(response => response.json())
        .then(data => {
            data.features.forEach(feature => {
...
//     fetch("https://raw.githubusercontent.com/adriannbhp/1214074-Adrianbhp-GIS/main/geoJSONLineString.json") // Ganti "data.json" dengan nama file JSON Anda
//         .then(response => response.json())
//         .then(data => {
//             data.features.forEach(feature => {
//                 if (feature.geometry.type === "LineString") {
...
document.addEventListener('DOMContentLoaded', () => {
    const map = new ol.Map({
        ...
        view: new ol.View({
            center: ol.proj.fromLonLat([107.71631553147262,-6.920749233088387]),
            zoom: 14.6
    ...
    const waypointSource = new ol.source.Vector({
        url: 'https://raw.githubusercontent.com/adriannbhp/open-layers/main/opengez/geoJSONPoint.json',
        format: new ol.format.GeoJSON()
    });

    const lineStringSource = new ol.source.Vector({
        url: 'https://raw.githubusercontent.com/adriannbhp/open-layers/main/opengez/geoJSONPolygon.json',
        format: new ol.format.GeoJSON()
    });

    const polylineSource = new ol.source.Vector({
        url: 'https://raw.githubusercontent.com/adriannbhp/open-layers/main/opengez/geoJSONLineString.json',
        format: new ol.format.GeoJSON()
    });
